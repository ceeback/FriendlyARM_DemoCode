...
ULONG *Tx_buffer;	//128[word]*16[blk]=8192[byte]
ULONG *Rx_buffer;	//128[word]*16[blk]=8192[byte]
volatile ULONG rd_cnt;
volatile ULONG wt_cnt;
volatile ULONG block;
volatile ULONG TR_end=0;
