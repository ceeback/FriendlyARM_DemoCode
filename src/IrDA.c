...
volatile UCHAR *IrDAdataPt;
volatile UCHAR *IrDAdataFl;
volatile ULONG IrDA_cnt,IrDA_end,IrDA_err,IrDA_BAUD;
volatile ULONG sirda_rGPBCON,sirda_rGPBDAT,sirda_rGPBUP;
volatile ULONG sirda_rGPHCON,sirda_rGPHDAT,sirda_rGPHUP;
volatile ULONG sirda_ULCON2,sirda_UCON2,sirda_UFCON2,sirda_UMCON2,sirda_UBRDIV2;
