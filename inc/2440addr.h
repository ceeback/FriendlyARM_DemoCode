...
#define rNFDATA8	(*(volatile UCHAR *)0x4E000010)     //NAND Flash data
...
#ifdef __BIG_ENDIAN
#define rUTXH0      (*(volatile UCHAR *)0x50000023)	//UART 0 Transmission Hold
#define rURXH0      (*(volatile UCHAR *)0x50000027)	//UART 0 Receive buffer
#define rUTXH1      (*(volatile UCHAR *)0x50004023)	//UART 1 Transmission Hold
#define rURXH1      (*(volatile UCHAR *)0x50004027)	//UART 1 Receive buffer
#define rUTXH2      (*(volatile UCHAR *)0x50008023)	//UART 2 Transmission Hold
#define rURXH2      (*(volatile UCHAR *)0x50008027)	//UART 2 Receive buffer

#define WrUTXH0(ch) (*(volatile UCHAR *)0x50000023)=(UCHAR)(ch)
#define RdURXH0()   (*(volatile UCHAR *)0x50000027)
#define WrUTXH1(ch) (*(volatile UCHAR *)0x50004023)=(UCHAR)(ch)
#define RdURXH1()   (*(volatile UCHAR *)0x50004027)
#define WrUTXH2(ch) (*(volatile UCHAR *)0x50008023)=(UCHAR)(ch)
#define RdURXH2()   (*(volatile UCHAR *)0x50008027)
...
#else //Little Endian
#define rUTXH0 (*(volatile UCHAR *)0x50000020)	//UART 0 Transmission Hold
#define rURXH0 (*(volatile UCHAR *)0x50000024)	//UART 0 Receive buffer
#define rUTXH1 (*(volatile UCHAR *)0x50004020)	//UART 1 Transmission Hold
#define rURXH1 (*(volatile UCHAR *)0x50004024)	//UART 1 Receive buffer
#define rUTXH2 (*(volatile UCHAR *)0x50008020)	//UART 2 Transmission Hold
#define rURXH2 (*(volatile UCHAR *)0x50008024)	//UART 2 Receive buffer

#define WrUTXH0(ch) (*(volatile UCHAR *)0x50000020)=(UCHAR)(ch)
#define RdURXH0()   (*(volatile UCHAR *)0x50000024)
#define WrUTXH1(ch) (*(volatile UCHAR *)0x50004020)=(UCHAR)(ch)
#define RdURXH1()   (*(volatile UCHAR *)0x50004024)
#define WrUTXH2(ch) (*(volatile UCHAR *)0x50008020)=(UCHAR)(ch)
#define RdURXH2()   (*(volatile UCHAR *)0x50008024)
...
#ifdef __BIG_ENDIAN
//<ERROR IF BIG_ENDIAN>
#define rFUNC_ADDR_REG     (*(volatile UCHAR *)0x52000143)	//Function address
#define rPWR_REG           (*(volatile UCHAR *)0x52000147)	//Power management
#define rEP_INT_REG        (*(volatile UCHAR *)0x5200014b)	//EP Interrupt pending and clear
#define rUSB_INT_REG       (*(volatile UCHAR *)0x5200015b)	//USB Interrupt pending and clear
#define rEP_INT_EN_REG     (*(volatile UCHAR *)0x5200015f)	//Interrupt enable
#define rUSB_INT_EN_REG    (*(volatile UCHAR *)0x5200016f)
#define rFRAME_NUM1_REG    (*(volatile UCHAR *)0x52000173)	//Frame number lower byte
#define rFRAME_NUM2_REG    (*(volatile UCHAR *)0x52000177)	//Frame number higher byte
#define rINDEX_REG         (*(volatile UCHAR *)0x5200017b)	//Register index
#define rMAXP_REG          (*(volatile UCHAR *)0x52000183)	//Endpoint max packet
#define rEP0_CSR           (*(volatile UCHAR *)0x52000187)	//Endpoint 0 status
#define rIN_CSR1_REG       (*(volatile UCHAR *)0x52000187)	//In endpoint control status
#define rIN_CSR2_REG       (*(volatile UCHAR *)0x5200018b)
#define rOUT_CSR1_REG      (*(volatile UCHAR *)0x52000193)	//Out endpoint control status
#define rOUT_CSR2_REG      (*(volatile UCHAR *)0x52000197)
#define rOUT_FIFO_CNT1_REG (*(volatile UCHAR *)0x5200019b)	//Endpoint out write count
#define rOUT_FIFO_CNT2_REG (*(volatile UCHAR *)0x5200019f)
#define rEP0_FIFO          (*(volatile UCHAR *)0x520001c3)	//Endpoint 0 FIFO
#define rEP1_FIFO          (*(volatile UCHAR *)0x520001c7)	//Endpoint 1 FIFO
#define rEP2_FIFO          (*(volatile UCHAR *)0x520001cb)	//Endpoint 2 FIFO
#define rEP3_FIFO          (*(volatile UCHAR *)0x520001cf)	//Endpoint 3 FIFO
#define rEP4_FIFO          (*(volatile UCHAR *)0x520001d3)	//Endpoint 4 FIFO
#define rEP1_DMA_CON       (*(volatile UCHAR *)0x52000203)	//EP1 DMA interface control
#define rEP1_DMA_UNIT      (*(volatile UCHAR *)0x52000207)	//EP1 DMA Tx unit counter
#define rEP1_DMA_FIFO      (*(volatile UCHAR *)0x5200020b)	//EP1 DMA Tx FIFO counter
#define rEP1_DMA_TTC_L     (*(volatile UCHAR *)0x5200020f)	//EP1 DMA total Tx counter
#define rEP1_DMA_TTC_M     (*(volatile UCHAR *)0x52000213)
#define rEP1_DMA_TTC_H     (*(volatile UCHAR *)0x52000217)
#define rEP2_DMA_CON       (*(volatile UCHAR *)0x5200021b)	//EP2 DMA interface control
#define rEP2_DMA_UNIT      (*(volatile UCHAR *)0x5200021f)	//EP2 DMA Tx unit counter
#define rEP2_DMA_FIFO      (*(volatile UCHAR *)0x52000223)	//EP2 DMA Tx FIFO counter
#define rEP2_DMA_TTC_L     (*(volatile UCHAR *)0x52000227)	//EP2 DMA total Tx counter
#define rEP2_DMA_TTC_M     (*(volatile UCHAR *)0x5200022b)
#define rEP2_DMA_TTC_H     (*(volatile UCHAR *)0x5200022f)
#define rEP3_DMA_CON       (*(volatile UCHAR *)0x52000243)	//EP3 DMA interface control
#define rEP3_DMA_UNIT      (*(volatile UCHAR *)0x52000247)	//EP3 DMA Tx unit counter
#define rEP3_DMA_FIFO      (*(volatile UCHAR *)0x5200024b)	//EP3 DMA Tx FIFO counter
#define rEP3_DMA_TTC_L     (*(volatile UCHAR *)0x5200024f)	//EP3 DMA total Tx counter
#define rEP3_DMA_TTC_M     (*(volatile UCHAR *)0x52000253)
#define rEP3_DMA_TTC_H     (*(volatile UCHAR *)0x52000257)
#define rEP4_DMA_CON       (*(volatile UCHAR *)0x5200025b)	//EP4 DMA interface control
#define rEP4_DMA_UNIT      (*(volatile UCHAR *)0x5200025f)	//EP4 DMA Tx unit counter
#define rEP4_DMA_FIFO      (*(volatile UCHAR *)0x52000263)	//EP4 DMA Tx FIFO counter
#define rEP4_DMA_TTC_L     (*(volatile UCHAR *)0x52000267)	//EP4 DMA total Tx counter
#define rEP4_DMA_TTC_M     (*(volatile UCHAR *)0x5200026b)
#define rEP4_DMA_TTC_H     (*(volatile UCHAR *)0x5200026f)

#else  // Little Endian
#define rFUNC_ADDR_REG     (*(volatile UCHAR *)0x52000140)	//Function address
#define rPWR_REG           (*(volatile UCHAR *)0x52000144)	//Power management
#define rEP_INT_REG        (*(volatile UCHAR *)0x52000148)	//EP Interrupt pending and clear
#define rUSB_INT_REG       (*(volatile UCHAR *)0x52000158)	//USB Interrupt pending and clear
#define rEP_INT_EN_REG     (*(volatile UCHAR *)0x5200015c)	//Interrupt enable
#define rUSB_INT_EN_REG    (*(volatile UCHAR *)0x5200016c)
#define rFRAME_NUM1_REG    (*(volatile UCHAR *)0x52000170)	//Frame number lower byte
#define rFRAME_NUM2_REG    (*(volatile UCHAR *)0x52000174)	//Frame number higher byte
#define rINDEX_REG         (*(volatile UCHAR *)0x52000178)	//Register index
#define rMAXP_REG          (*(volatile UCHAR *)0x52000180)	//Endpoint max packet
#define rEP0_CSR           (*(volatile UCHAR *)0x52000184)	//Endpoint 0 status
#define rIN_CSR1_REG       (*(volatile UCHAR *)0x52000184)	//In endpoint control status
#define rIN_CSR2_REG       (*(volatile UCHAR *)0x52000188)
#define rOUT_CSR1_REG      (*(volatile UCHAR *)0x52000190)	//Out endpoint control status
#define rOUT_CSR2_REG      (*(volatile UCHAR *)0x52000194)
#define rOUT_FIFO_CNT1_REG (*(volatile UCHAR *)0x52000198)	//Endpoint out write count
#define rOUT_FIFO_CNT2_REG (*(volatile UCHAR *)0x5200019c)
#define rEP0_FIFO          (*(volatile UCHAR *)0x520001c0)	//Endpoint 0 FIFO
#define rEP1_FIFO          (*(volatile UCHAR *)0x520001c4)	//Endpoint 1 FIFO
#define rEP2_FIFO          (*(volatile UCHAR *)0x520001c8)	//Endpoint 2 FIFO
#define rEP3_FIFO          (*(volatile UCHAR *)0x520001cc)	//Endpoint 3 FIFO
#define rEP4_FIFO          (*(volatile UCHAR *)0x520001d0)	//Endpoint 4 FIFO
#define rEP1_DMA_CON       (*(volatile UCHAR *)0x52000200)	//EP1 DMA interface control
#define rEP1_DMA_UNIT      (*(volatile UCHAR *)0x52000204)	//EP1 DMA Tx unit counter
#define rEP1_DMA_FIFO      (*(volatile UCHAR *)0x52000208)	//EP1 DMA Tx FIFO counter
#define rEP1_DMA_TTC_L     (*(volatile UCHAR *)0x5200020c)	//EP1 DMA total Tx counter
#define rEP1_DMA_TTC_M     (*(volatile UCHAR *)0x52000210)
#define rEP1_DMA_TTC_H     (*(volatile UCHAR *)0x52000214)
#define rEP2_DMA_CON       (*(volatile UCHAR *)0x52000218)	//EP2 DMA interface control
#define rEP2_DMA_UNIT      (*(volatile UCHAR *)0x5200021c)	//EP2 DMA Tx unit counter
#define rEP2_DMA_FIFO      (*(volatile UCHAR *)0x52000220)	//EP2 DMA Tx FIFO counter
#define rEP2_DMA_TTC_L     (*(volatile UCHAR *)0x52000224)	//EP2 DMA total Tx counter
#define rEP2_DMA_TTC_M     (*(volatile UCHAR *)0x52000228)
#define rEP2_DMA_TTC_H     (*(volatile UCHAR *)0x5200022c)
#define rEP3_DMA_CON       (*(volatile UCHAR *)0x52000240)	//EP3 DMA interface control
#define rEP3_DMA_UNIT      (*(volatile UCHAR *)0x52000244)	//EP3 DMA Tx unit counter
#define rEP3_DMA_FIFO      (*(volatile UCHAR *)0x52000248)	//EP3 DMA Tx FIFO counter
#define rEP3_DMA_TTC_L     (*(volatile UCHAR *)0x5200024c)	//EP3 DMA total Tx counter
#define rEP3_DMA_TTC_M     (*(volatile UCHAR *)0x52000250)
#define rEP3_DMA_TTC_H     (*(volatile UCHAR *)0x52000254)
#define rEP4_DMA_CON       (*(volatile UCHAR *)0x52000258)	//EP4 DMA interface control
#define rEP4_DMA_UNIT      (*(volatile UCHAR *)0x5200025c)	//EP4 DMA Tx unit counter
#define rEP4_DMA_FIFO      (*(volatile UCHAR *)0x52000260)	//EP4 DMA Tx FIFO counter
#define rEP4_DMA_TTC_L     (*(volatile UCHAR *)0x52000264)	//EP4 DMA total Tx counter
#define rEP4_DMA_TTC_M     (*(volatile UCHAR *)0x52000268)
#define rEP4_DMA_TTC_H     (*(volatile UCHAR *)0x5200026c)
#endif   // __BIG_ENDIAN
...
// RTC
#ifdef __BIG_ENDIAN
#define rRTCCON    (*(volatile UCHAR *)0x57000043)	//RTC control
#define rTICNT     (*(volatile UCHAR *)0x57000047)	//Tick time count
#define rRTCALM    (*(volatile UCHAR *)0x57000053)	//RTC alarm control
#define rALMSEC    (*(volatile UCHAR *)0x57000057)	//Alarm second
#define rALMMIN    (*(volatile UCHAR *)0x5700005b)	//Alarm minute
#define rALMHOUR   (*(volatile UCHAR *)0x5700005f)	//Alarm Hour
#define rALMDATE   (*(volatile UCHAR *)0x57000063)	//Alarm date   //edited by junon
#define rALMMON    (*(volatile UCHAR *)0x57000067)	//Alarm month
#define rALMYEAR   (*(volatile UCHAR *)0x5700006b)	//Alarm year
#define rRTCRST    (*(volatile UCHAR *)0x5700006f)	//RTC round reset
#define rBCDSEC    (*(volatile UCHAR *)0x57000073)	//BCD second
#define rBCDMIN    (*(volatile UCHAR *)0x57000077)	//BCD minute
#define rBCDHOUR   (*(volatile UCHAR *)0x5700007b)	//BCD hour
#define rBCDDATE   (*(volatile UCHAR *)0x5700007f)	//BCD date  //edited by junon
#define rBCDDAY    (*(volatile UCHAR *)0x57000083)	//BCD day   //edited by junon
#define rBCDMON    (*(volatile UCHAR *)0x57000087)	//BCD month
#define rBCDYEAR   (*(volatile UCHAR *)0x5700008b)	//BCD year

#else //Little Endian
#define rRTCCON    (*(volatile UCHAR *)0x57000040)	//RTC control
#define rTICNT     (*(volatile UCHAR *)0x57000044)	//Tick time count
#define rRTCALM    (*(volatile UCHAR *)0x57000050)	//RTC alarm control
#define rALMSEC    (*(volatile UCHAR *)0x57000054)	//Alarm second
#define rALMMIN    (*(volatile UCHAR *)0x57000058)	//Alarm minute
#define rALMHOUR   (*(volatile UCHAR *)0x5700005c)	//Alarm Hour
#define rALMDATE   (*(volatile UCHAR *)0x57000060)	//Alarm date  // edited by junon
#define rALMMON    (*(volatile UCHAR *)0x57000064)	//Alarm month
#define rALMYEAR   (*(volatile UCHAR *)0x57000068)	//Alarm year
#define rRTCRST    (*(volatile UCHAR *)0x5700006c)	//RTC round reset
#define rBCDSEC    (*(volatile UCHAR *)0x57000070)	//BCD second
#define rBCDMIN    (*(volatile UCHAR *)0x57000074)	//BCD minute
#define rBCDHOUR   (*(volatile UCHAR *)0x57000078)	//BCD hour
#define rBCDDATE   (*(volatile UCHAR *)0x5700007c)	//BCD date  //edited by junon
#define rBCDDAY    (*(volatile UCHAR *)0x57000080)	//BCD day   //edited by junon
#define rBCDMON    (*(volatile UCHAR *)0x57000084)	//BCD month
#define rBCDYEAR   (*(volatile UCHAR *)0x57000088)	//BCD year
#endif  //RTC
