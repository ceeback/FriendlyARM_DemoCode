...
#define CAM_RGB16B						0
#define CAM_RGB24B						(1UL)

#define CAM_ITU601						(1UL)
#define CAM_ITU656						(0)
...
#define CAM_CODEC_IN_422				(1UL)

#define CAM_CODEC_OUT_420				(0)
#define CAM_CODEC_OUT_422				(1UL)
...
#define CAM_CODEC_SACLER_START_BIT			(1UL<<15)
#define CAM_PVIEW_SACLER_START_BIT			(1UL<<15)

#define CAM_CAMIF_GLOBAL_CAPTURE_ENABLE_BIT		(1UL<<31)
#define CAM_CODEC_SCALER_CAPTURE_ENABLE_BIT		(1UL<<30)
#define CAM_PVIEW_SCALER_CAPTURE_ENABLE_BIT		(1UL<<29)

//camTestMode
#define CAM_TEST_MODE_PVIEW				(1UL<<0)
#define CAM_TEST_MODE_CODEC				(1UL<<1)

//camCodecStatus, camPviewStatus
#define CAM_STARTED						(0)
#define CAM_STOP_ISSUED				(1UL)
